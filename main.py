...
# # UPLOAD_DIR = "uploads"
# # OUTPUT_DIR = "outputs"
# # AUDIVERIS_DIR = "/home/kaval/Documents/audiveris"  # <-- Ajusta esta ruta
...
# #         return templates.TemplateResponse("index.html", {"request": request, "error": "Solo se permiten archivos PDF"})
...
# #     ]
# #     subprocess.run(command, cwd=AUDIVERIS_DIR)

# #     # Convertir XML a MIDI con MuseScore
# #     basename = filename.rsplit(".", 1)[0]
# #     midi_name = f"{basename}.midi"
# #     midi_path = os.path.join(OUTPUT_DIR, midi_name)
# #     xml_path = os.path.join(OUTPUT_DIR, f"{basename}.mxl")
...
# #                     "request": request,
# #                     "error": "MuseScore no está instalado o no se pudo ejecutar."
# #                 })

# #     # Mover MIDI a carpeta pública
# #     if os.path.exists(midi_path):
# #         public_midi_path = os.path.join(PUBLIC_MIDI_DIR, midi_name)
# #         shutil.move(midi_path, public_midi_path)
# #         midi_url = f"/static/midi/{midi_name}"
# #         return templates.TemplateResponse("index.html", {
# #             "request": request,
# #             "midi_url": midi_url
# #         })
...
# #         return templates.TemplateResponse("index.html", {
# #             "request": request,
# #             "error": "No se pudo generar el archivo MIDI."
# #         })
...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["*"],  # Permitir todos los orígenes, o puedes definir los específicos
